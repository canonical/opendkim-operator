...
The OpenDKIM charm installs and configures the [OpenDKIM](http://www.opendkim.org/) snap and offers
...
(from the `opendkim-tools` apt package, or `opendkim.genkey` if using the snap).
