...
The `spread/.extension` helper script is generated by Snapcraft's `init --profile test`
command and committed to the repository so that tests can be run locally without extra setup.
